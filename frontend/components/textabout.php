<section class="container" id="first-carousel">
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" id="img" style="background-image: url(/assets/imgs/king3.jpg);">
                <div class="carousel-caption d-none d-md-block">
                    <h5><span id="carousel-text">Histórias de Stephen King</span></h5>
                    <img src="" alt="">
                </div>
            </div>
            <div class="carousel-item" id="img" style="background-image: url(/assets/imgs/percy-jackson-universe.jpeg);">
                <img src="" alt="">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" id="img" style="background-image: url(/assets/imgs/harrynew.png); background-position:bottom;">
                <img src="" alt="">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class=" text-center">
        <div class="row">
            ...
            <div class="col-sm-0  col-md-0 col-lg-4 col-xl-4">
                <img src="/assets/imgs/reading400.png" alt="">
